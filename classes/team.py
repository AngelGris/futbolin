...
class Team:
    ...
    def __init__(self, id, field, match_type, db_connection, reset_counter = False):
        ...
        if (result['formation'] != ''):
            ...
            for pid in formation:
                ...
                self._players.append(Player.Player(self._index, pid, count, [positioning[0][0], positioning[0][1]], [positioning[1][0], positioning[1][1]], match_type, db_connection))
